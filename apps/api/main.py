...
# Fallback to services/.env if not found
if not os.environ.get("SUPABASE_URL"):
    print("DEBUG: .env not found in root, trying services/.env")
...
if SUPABASE_URL and SUPABASE_KEY:
    ...
    print("CRITICAL: SUPABASE_URL or SUPABASE_KEY missing from environment!")
